...
public class UnderGroundGrid : MonoBehaviour
{
    ...
    public void SetNode(BaseMapNode node)
    {
        int posx = CalcXaxis(node.gameObject.transform.position.x);
        int posy = CalcYaxis(node.gameObject.transform.position.y);
    ...
    public void MakeGrid()
    {
        ...
        {
            tile = tiles[i];
            SetNode(tile.GetComponent<BaseMapNode>());
        }
    }
